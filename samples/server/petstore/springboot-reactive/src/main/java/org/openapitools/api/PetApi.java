/**
 * NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech) (5.3.0-DMB).
...
public interface PetApi {
    ...
    default Mono<ResponseEntity<Void>> addPet(@ApiParam(value = "Pet object that needs to be added to the store", required = true) @Valid @RequestBody Mono<Pet> body, @springfox.documentation.annotations.ApiIgnore final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<Void>> deletePet(@ApiParam(value = "Pet id to delete", required = true) @PathVariable("petId") Long petId,@ApiParam(value = "") @RequestHeader(value = "api_key", required = false) String apiKey, @springfox.documentation.annotations.ApiIgnore final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<Flux<Pet>>> findPetsByStatus(@NotNull @ApiParam(value = "Status values that need to be considered for filter", required = true, allowableValues = "available, pending, sold") @Valid @RequestParam(value = "status", required = true) List<String> status, @springfox.documentation.annotations.ApiIgnore final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<Flux<Pet>>> findPetsByTags(@NotNull @ApiParam(value = "Tags to filter by", required = true) @Valid @RequestParam(value = "tags", required = true) Set<String> tags, @springfox.documentation.annotations.ApiIgnore final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<Pet>> getPetById(@ApiParam(value = "ID of pet to return", required = true) @PathVariable("petId") Long petId, @springfox.documentation.annotations.ApiIgnore final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<Void>> updatePet(@ApiParam(value = "Pet object that needs to be added to the store", required = true) @Valid @RequestBody Mono<Pet> body, @springfox.documentation.annotations.ApiIgnore final ServerWebExchange exchange) {
